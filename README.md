...
> Este proyecto nace con el objetivo de explorar y demostrar capacidades en el desarrollo de soluciones tecnológicas enfocadas en **TEST-BACK1**.  
...
```bash
git clone https://github.com/ramiju81/TEST-BACK1.git
```
